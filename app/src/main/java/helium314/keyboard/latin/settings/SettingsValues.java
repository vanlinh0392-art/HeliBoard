...
public class SettingsValues {
        ...
        public final float mSpaceBarLengthScale;
        public final boolean mHidePeriodKey;
        public final boolean mEmojiKeyRight;
        ...
        public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
                ...
                mVoiceInputEnabled = prefs.getBoolean(Settings.PREF_VOICE_INPUT, Defaults.PREF_VOICE_INPUT);
                mShowsVoiceInputKey = mVoiceInputEnabled && mInputAttributes.mShouldShowVoiceInputKey;
                ...
                mSpaceBarLengthScale = prefs.getFloat(Settings.PREF_SPACE_BAR_LENGTH_SCALE,
                                Defaults.PREF_SPACE_BAR_LENGTH_SCALE);
                mHidePeriodKey = prefs.getBoolean(Settings.PREF_HIDE_PERIOD_KEY,
                                Defaults.PREF_HIDE_PERIOD_KEY);
                mEmojiKeyRight = prefs.getBoolean(Settings.PREF_EMOJI_KEY_RIGHT,
                                Defaults.PREF_EMOJI_KEY_RIGHT);
