...
public final class InputLogic {
    ...
    public String getCombiningSpec() {
        return mWordComposer.getCombiningSpec();
    }
    ...
    private void handleConsumedEvent(final Event event, final InputTransaction inputTransaction) {
        ...
        if (mWordComposer.isComposingWord()) {
            ...
            // Composing word became empty after combiner consumed a delete.
            // Clear the composing text from the editor to avoid ghost characters.
    ...
    private void handleBackspaceEvent(final Event event, final InputTransaction inputTransaction,
        ...
        if (mWordComposer.isComposingWord()) {
            ...
            mConnection.refreshTextCacheForDestructiveOperation();
            if (mConnection.hasSelection()) {
